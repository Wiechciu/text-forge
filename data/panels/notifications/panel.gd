...
func _editor_notification(type: int, title: String, text: String) -> void:
	var notification_panel: NotificationPanel = Global.gload("res://data/panels/notifications/notification.tscn").instantiate()
	...
	if not (get_parent().current_tab == index and visible):
		Global.get_panel_manager().change_panel_icon(place, index, Global.gload("res://data/panels/notifications/notification.png"))
	if not mute:
...
func _on_tab_changed() -> void:
	if get_parent().current_tab == index and visible:
		Global.get_panel_manager().change_panel_icon(place, index, Global.gload("res://data/panels/notifications/icon.png"))
...
func _on_mute_toggled(toggled_on: bool) -> void:
	if toggled_on:
		mute_bottom.icon = Global.gload("res://data/panels/notifications/mute.png")
	else:
		mute_bottom.icon = Global.gload("res://data/panels/notifications/icon.png")
	mute = toggled_on
